...
class LowestPriceCard extends StatelessWidget {
  int? index;
  ...
  var iconColor;
  var shadowColor;
   LowestPriceCard({Key? key,this.index,this.containerBorderColor,this.data,this.descriptionColor,this.priceColor,this.primaryColor,this.iconColor,this.shadowColor}) : super(key: key);
