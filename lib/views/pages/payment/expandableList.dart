import 'package:fastkart/views/pages/payment/childExpandable.dart';
...
class ExpandableListView extends StatelessWidget {
  ...
  ExpandableListView({Key? key,this.index,this.titleColor,this.child,this.title,this.onPressed,this.lightPrimary,this.isExpanded}) : super(key: key);
